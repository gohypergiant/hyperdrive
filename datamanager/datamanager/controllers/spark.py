...
import os
import pyspark
from ..datamodel.datarepo import DataRepo
...
class SparkController:
    def __init__(self, dataclient, decorate=True):
        ...
        self.set_datarepo(
            volume_name=dataclient.volume_name,
            volume_region=dataclient.volume_region,
            storage_provider=dataclient.storage_provider,
        )
    ...
    def decorate_spark_methods(self, spark_class):
        ...
        for method in method_list:
            decorated_method = spark_decorator(getattr(spark_class, method), self)
    ...
    def set_datarepo(
        ...
        access_key = datarepo.access_key
        secret_key = datarepo.secret_access_key
        volume_region = "s3-" + volume_region + ".amazonaws.com"
