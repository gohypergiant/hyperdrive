...
curl -O https://raw.githubusercontent.com/jupyter/docker-stacks/master/base-notebook/initial-condarc
...
curl -O https://raw.githubusercontent.com/jupyter/docker-stacks/master/pyspark-notebook/ipython_kernel_config.py
